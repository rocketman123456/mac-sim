...
class MojocoSim(Node):
    ...
    def publish_msg(self):
        ...
        if self.apply_noise:
            qp += np.random.normal(0.0, 1.0, 10) * self.joint_pos_noise_range
            qv += np.random.normal(0.0, 1.0, 10) * self.joint_vel_noise_range
        ...
        self.joint_state.position = 10 * [float(0.0)]
        self.joint_state.velocity = 10 * [float(0.0)]
